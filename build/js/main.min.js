...
/* harmony import */ var _modules_scroll_smooth_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/scroll-smooth.js */ "./js/modules/scroll-smooth.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_burger_menu_js__WEBPACK_IMPORTED_MODULE_2__["openMainMenu"])();
  Object(_modules_scroll_smooth_js__WEBPACK_IMPORTED_MODULE_3__["scrollSmooth"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
/*!***********************************!*\
  !*** ./js/modules/burger-menu.js ***!
  \***********************************/
/*! exports provided: openMainMenu, closeMainMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "openMainMenu", function() { return openMainMenu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "closeMainMenu", function() { return closeMainMenu; });
var navMain = document.querySelector('[data-main-nav]');
var navToggle = document.querySelector('[data-burger]');
...
var advantageTarget = document.getElementById('advantage');
var introTarget = document.getElementById('intro');
var cruisesTarget = document.getElementById('cruises');
var contactsTarget = document.getElementById('contacts');
var linkAdvantage = document.querySelector('a[href="#advantage"]');
var linkIntro = document.querySelector('a[href="#intro"]');
var linkCruises = document.querySelector('a[href="#cruises"]');
var linkContacts = document.querySelector('a[href="#contacts"]');

function scrollSmooth() {
  linkAdvantage.addEventListener('click', function (evt) {
    evt.preventDefault();
    moveTo.move(advantageTarget);
    Object(_modules_burger_menu__WEBPACK_IMPORTED_MODULE_1__["closeMainMenu"])();
  });
  linkIntro.addEventListener('click', function (evt) {
    evt.preventDefault();
    moveTo.move(introTarget);
    Object(_modules_burger_menu__WEBPACK_IMPORTED_MODULE_1__["closeMainMenu"])();
  });
  linkCruises.addEventListener('click', function (evt) {
    evt.preventDefault();
